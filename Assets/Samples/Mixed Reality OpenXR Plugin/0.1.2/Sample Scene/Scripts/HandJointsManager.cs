...
namespace Microsoft.MixedReality.OpenXR.Samples
{
    public class HandJointsManager : MonoBehaviour
    {
        ...
        private void Application_onBeforeRender()
        {
            ...
            {
                UpdateHandJointsUsingOpenXRExtension(LeftHandTracker, leftHand, FrameTime.BeforeRender);
            }
            if (rightHandJointSource == HandJointSource.OpenXRExtension)
            {
                UpdateHandJointsUsingOpenXRExtension(RightHandTracker, rightHand, FrameTime.BeforeRender);
            }
        }
